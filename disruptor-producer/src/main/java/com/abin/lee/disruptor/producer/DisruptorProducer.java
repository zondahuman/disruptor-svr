package com.abin.lee.disruptor.producer;
...
public class DisruptorProducer {
    ...
    public static void createPruducer() throws ExecutionException, InterruptedException {
        ...
        future.get();//等待生产者结束
        Thread.sleep(1000000);//等上1秒，等消费都处理完成
